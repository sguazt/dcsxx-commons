/**
 * \file dcs/meta/pop_front.hpp
 *
 * \brief Performs a removal at the beginning of the sequence.
 *
...
#ifndef DCS_META_POP_FRONT_HPP
#define DCS_META_POP_FRONT_HPP
...
struct pop_front: public detail::pop_front_impl< typename sequence_tag<SequenceT>::type >::template apply<SequenceT>
{
};
