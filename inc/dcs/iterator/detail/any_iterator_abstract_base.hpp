/**
 * \file dcs/iterator/detail/any_iterator_abstract_base.hpp
 *
 * \brief Base class for generic (type-erased) iterator.
 *
...
namespace dcs { namespace iterator { namespace detail {
